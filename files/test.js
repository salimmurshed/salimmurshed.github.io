  ...
  [818],
  {
    ...
    7211: function (e, t, a) {
      ...
      var s = a(5893),
        r = a(7294);
      function n() {
        let e = "font-medium text-slate-200";
        return (0, s.jsxs)("div", {
          children: [
            (0, s.jsx)("p", {
              className: "mb-4",
            ...
            (0, s.jsxs)("p", {
              ...
              children: [
                ...
                ". I lead engineering efforts across our component library and front end platform, partnering closely with designers and engineers to ensure accessibility is built into the foundation of everything we ship.",
              ],
            }),
            (0, s.jsxs)("p", {
              className: "mb-4",
              children: [
                "Previously, I’ve worked across a wide range of environments — from product studios to startups and large tech companies — including",
                " ",
                (0, s.jsx)("a", {
                  className: e,
                ...
                " ",
                "a few years ago which walks through building a real-world, API-driven application from scratch. These experiences have shaped how I think about building products that are both well-crafted and widely usable.",
              ],
            }),
            (0, s.jsxs)("p", {
              children: [
                "In my spare time, you can usually find me climbing, playing tennis, hanging out with my wife and two cats, or running around Hyrule searching for",
                " ",
                (0, s.jsxs)("span", {
                  className:
              ...
              children: [
                {
                  ...
                  desc: "Designed and developed advanced cross-platform Flutter applications[cite: 3]. Converted Figma designs into functional code[cite: 3], handled HTTP/DIO CRUD operations[cite: 3], integrated Firebase services and 3rd-party APIs like Google Maps[cite: 3], and managed Play Store/App Store deployments (AAB/IPA)[cite: 3].",
                  tech: [
                    "Flutter",
                    "Dart",
                    "Firebase",
                ...
                },
                {
                  ...
                  positions: ["Sr. Software Engineer"],
                  desc: "Fixed issues and optimized live, server-connected Flutter apps[cite: 3]. Integrated backend APIs[cite: 3], managed Firebase Authentication/Firestore[cite: 3], resolved server-response bugs[cite: 3], and generated app bundles for store deployment[cite: 3].",
                  tech: [
                    "Flutter",
                    "Dart",
                    "Firebase",
                ...
                },
                {
                  ...
                  desc: "Built cross-platform Flutter medical service applications[cite: 3]. Implemented Dio CRUD requests[cite: 3], integrated AWS Amplify (DataStore, Storage, Auth)[cite: 3], and integrated dynamic 3rd-party backend APIs[cite: 3].",
                  tech: [
                    "Flutter",
                    "Dart",
                    "AWS Amplify",
                ...
                },
                {
                  ...
                  desc: "Completed ongoing Flutter projects (including the 'Two It' social app)[cite: 3]. Managed HTTP and Firebase authentication fixes[cite: 3], resolved backend API issues[cite: 3], and led client issue resolutions[cite: 3].",
                  tech: [
                    "Flutter",
                    "Dart",
                    "Firebase",
                ...
                },
                {
                  ...
                  desc: "Built end-to-end Flutter mobile applications and custom Laravel backends[cite: 3]. Created and integrated REST APIs[cite: 3], developed database structures[cite: 3], and delivered full-stack mobile solutions[cite: 3].",
                  tech: [
                    "Flutter",
                    "Laravel",
                    "PHP",
            ...
            children: [
              {
                ...
                image: {
                  src: "/images/writing/ai-parade.png",
                  alt: 'Welcome to Black Parade by My Chemical Romance text with "Black" changed to "AI"',
                },
              },
              {
      ...
      function k() {
        ...
        return (0, s.jsxs)("div", {
          ...
          children: [
            (0, s.jsx)(w.Z, { pathname: "/", title: "Brittany Chiang" }),
